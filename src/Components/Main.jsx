...
const Main = () => {
    ...
    return (
        ...
        <div className='w-[100%] lg:w-[90%] mx-auto my-0 flex flex-col-reverse lg:flex-row justify-evenly items-center'>
            <div className='text-start w-[90vw] lg:w-[40vw]'>
                ...
                <div className='text-[1.1em] bg-gradient-to-r from-purple-700 to-blue-700 w-fit px-8 py-4 rounded-lg my-6 cursor-pointer hover:scale-105'>Check Resume</div>
            </div>
